                    ...
                    <div className="space-y-4 text-muted-foreground">
                        <AnimatedSection delay={200} animation="fadeUp">
                            <p className="text-lg text-left leading-relaxed">
                                I'm a passionate Full Stack Developer who recently completed B.Tech in Information Technology with a CGPA
                                of 7.5. I worked as a Software Development Intern at GoRoots, where I enhanced user
